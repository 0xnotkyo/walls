...
const branch = "main";
const folders = ["images/mocha", "images/blue", "images/colourize"]; // Añadir más carpetas si es necesario
const imagesPerRow = 4; // 4 imágenes por fila
const rowsPerPage = 6; // 6 filas por página (24 imágenes totales)
const imagesPerPage = imagesPerRow * rowsPerPage; // Exactamente 24 imágenes por página
...
async function fetchImages() {
    ...
    try {
        for (const folder of folders) {
            ...
            while (true) {
                const apiUrl = `https://api.github.com/repos/${repoOwner}/${repoName}/contents/${folder}?ref=${branch}&per_page=${perPage}&page=${page}`;
        ...
        // Filtrar solo archivos y ordenar
